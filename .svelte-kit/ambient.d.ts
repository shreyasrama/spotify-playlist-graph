...
declare module '$env/static/private' {
	...
	export const BOTO_CONFIG: string;
	...
	export const HerokuPath: string;
	...
	export const npm_package_dependencies_force_graph: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_REDIRECT_URI: string;
	export const PUBLIC_SPOTIFY_AUTHORIZATION_ENDPOINT: string;
	export const PUBLIC_SPOTIFY_TOKEN_ENDPOINT: string;
	export const PUBLIC_SPOTIFY_API_URL: string;
}
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_force_graph: string;
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_SPOTIFY_AUTHORIZATION_ENDPOINT: string;
		PUBLIC_SPOTIFY_TOKEN_ENDPOINT: string;
